...
const rulesConf = {
    ...
    rules: [
        ...
        {
            desc: 'should use gff-jira-version and run it on commitmsg',
            errorMsg: 'install gff-jira-version and add it to scripts commitmsg',
            run: 'npm i gff-jira-version --save-dev',
