...
const rulesConf = {
    ...
    rules: [
        ...
        },
        {
            ...
            errorMsg: 'remove require-polyfill from package.json, then run \n' +
                'npm install --save-dev require-polyfill\n',
            fn: shouldUsePublicRequirePolyfill
        },
        {
            desc: 'should eslint-config-gfp 3.0.0 and up',
            errorMsg: 'set eslint-config-gfp to use version "^3.0.0" in package.json',
            fn: shouldUseEslintConfigGfp300
        },
        {
            desc: 'should run gfp-doctor after install',
            errorMsg: 'add the following to npm scripts:\n' +
