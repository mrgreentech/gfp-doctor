...
const rulesConf = {
    ...
    rules: [
        ...
        },
        {
            ...
            errorMsg:
                'remove "karma-phantomjs-launcher" from package.json and install karma-chrome-launcher instead, or just run run:',
            run:
        ...
        },
        {
            ...
            errorMsg:
                'set eslint-config-gfp to use version "^3.0.0" in package.json or run:',
            run: 'npm install --save-dev eslint-config-gfp@3.3.0',
